...
class ChronoUserDefaults
{
    ...
    class func setupFistTimeValues()
    {
        ...
        UserDefaults.standard.setValue("1", forKey: "defaultDayRate")
        ...
        DataController.sharedInstance.addFeeRate(name: "DAY RATE", fee: nil, hours: nil, custom: false, interval: "hours")
